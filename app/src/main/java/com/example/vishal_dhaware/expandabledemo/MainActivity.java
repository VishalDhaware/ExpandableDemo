package com.example.vishal_dhaware.expandabledemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    List<String> listDataHeader;//this collection of string
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(
                        ...
                        .show();
                if (childPosition==2){
                    Toast.makeText(getApplicationContext(),"Zigalala who Zigalala",Toast.LENGTH_SHORT).show();
                }
